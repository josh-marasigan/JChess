...
public class King extends ChessPiece {
	...
	public King(int x, int y, String token) {
		super(x, y, token);
	...
	public boolean isValidMove(int oldX, int oldY, int newX, int newY) {
		...
		if(isPlayerOne) {
			...
			// Check if movement within bounds of King.	Diagonal, Up, Down, L, R
			if((Math.abs(newX - oldX) == 1) && (Math.abs(newY - oldY) == 1) 
					|| (Math.abs(newX - oldX) == 1) && (Math.abs(newY - oldY) == 0)
					|| (Math.abs(newX - oldX) == 0) && (Math.abs(newY - oldY) == 1)) {
			...
			// Check if movement within bounds of King.	
			if((Math.abs(newX - oldX) == 1) && (Math.abs(newY - oldY) == 1) 
					|| (Math.abs(newX - oldX) == 1) && (Math.abs(newY - oldY) == 0)
					|| (Math.abs(newX - oldX) == 0) && (Math.abs(newY - oldY) == 1)) {
